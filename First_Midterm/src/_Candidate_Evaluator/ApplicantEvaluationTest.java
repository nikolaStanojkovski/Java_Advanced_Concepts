...
public class ApplicantEvaluationTest {
    public static void main(String[] args) {
        ...
        } catch (InvalidEvaluaton invalidEvaluation) {
...
class InvalidEvaluaton extends RuntimeException {
    public InvalidEvaluaton(Evaluator.TYPE type) {
        super(type.toString());
    }
}

class EvaluatorBuilder {
    public static Evaluator build(Evaluator.TYPE type) throws InvalidEvaluaton {
        ...
        switch (type) {
            ...
            case NO_CRIMINAL_RECORD_AND_MORE_EXPERIENCE:
                return applicant -> !applicant.hasCriminalRecord() &&
                        applicant.getEmploymentYears() >= 10;
            ...
            case NO_CRIMINAL_RECORD_AND_MORE_CREDIT_SCORE:
                return applicant -> !applicant.hasCriminalRecord() &&
                        applicant.getCreditScore() >= 500;
            default:
                throw new InvalidEvaluaton(type);
        }
